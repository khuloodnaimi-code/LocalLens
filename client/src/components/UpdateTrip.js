    ...
    <div style={{ padding: "20px" }}>
      ...
      <form onSubmit={handleUpdate} style={{ maxWidth: "500px" }}>
        ...
        <div style={{ marginBottom: "10px" }}>
          ...
          <input type="number" value={lat} onChange={e => setLat(e.target.value)} style={{ width: "100%" }} />
        </div>

        <div style={{ marginBottom: "10px" }}>
          <label>Longitude:</label>
          <input type="number" value={lng} onChange={e => setLng(e.target.value)} style={{ width: "100%" }} />
        </div>

        <div style={{ marginBottom: "10px" }}>
          <label>Image URL:</label>
          <input type="text" value={image} onChange={e => setImage(e.target.value)} style={{ width: "100%" }} placeholder="Paste image URL here" />
        </div>
        ...
        <button type="submit" style={{ padding: "10px 20px", marginRight: "10px" }}>Update Trip</button>
        <button type="button" onClick={() => setShowDeleteConfirm(true)} style={{ padding: "10px 20px", backgroundColor: "red", color: "white" }}>Delete Trip</button>
      </form>
      ...
      {showDeleteConfirm && (
        <div style={{
          ...
          <div style={{ backgroundColor: "white", padding: "20px", borderRadius: "8px", textAlign: "center", minWidth: "300px" }}>
            <p>Are you sure you want to delete this trip?</p>
            <div style={{ marginTop: "15px" }}>
              <button onClick={handleDelete} style={{ padding: "8px 15px", marginRight: "10px", backgroundColor: "red", color: "white" }}>Sure</button>
              <button onClick={() => setShowDeleteConfirm(false)} style={{ padding: "8px 15px" }}>Cancel</button>
            </div>
          </div>
        </div>
      )}
